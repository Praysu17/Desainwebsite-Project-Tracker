  ...
  return (
    <div className="min-h-screen bg-[#071322] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        {/* Login Box */}
        <div className="mt-8 bg-slate-900/90 backdrop-blur-md py-8 px-6 sm:px-10 shadow-2xl rounded-3xl border border-slate-800">
          <div className="mb-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="sugeng@agency.com atau Sugeng Prayitno"
        ...
        <p className="mt-6 text-center text-xs text-slate-500">
          &copy; {new Date().getFullYear()} {settings.agencyName || 'Sugeng Project Tracker'}. All rights reserved.
        </p>
      </div>
    </div>
  );
